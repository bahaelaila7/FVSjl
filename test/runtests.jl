...
@testset "FVSjl" begin
    ...
    include("unit/test_rd_dbs.jl")          # FVS_RD_Sum DBS table (dbsrd.f DBSRD1, RDSUM+RRDOUT): rd_sum_report (rdpr.f aggregation) — LIVE-oracle vs FVSkt_clean, 1990 inventory row BIT-EXACT + projected rows bit-exact-or-cornered (#206 WRD growth straddle); 16/20 cols (4 new-inf follow-on)
