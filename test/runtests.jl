...
@testset "FVSjl" begin
    ...
    include("integration/test_ppe_harvest.jl") # PPE MXHRVP multistand harvest scheduling — HVSEL (hvsel.f) greedy priority-ranked target-constrained stand selection bit-exact vs gfortran-16 driver-golden over the historical FVSppe objects (8 branch cases + 200-case fuzz); additive/inert until the master-cycle seam
