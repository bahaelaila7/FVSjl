#!/usr/bin/env bash
# ls_oracle.sh — produce live FVS Lake States ground-truth output for a .key file.
#
...
#
# NOTE: tests/FVSls/lst01.sum.save is STALE (built from source dated 20250930; the
