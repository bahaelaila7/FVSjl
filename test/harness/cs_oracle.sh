...
# a working binary (/workspace/FVSjl/tmp/oracles/FVScs_new) from the resolved .o files in the NE build dir
...
BIN="${FVSNE_BIN:-/workspace/FVSjl/tmp/oracles/FVScs_new}"
