...
C.... THE OPTION PROCESSOR.
      ...
      CRASH = PRMS(1)
      THRESH = PRMS(2)
      WRITE(0,*) 'WIN-HEAD ICYC=',ICYC,
     &  ' CRASHx=',TRANSFER(CRASH,1),
     &  ' THRESHx=',TRANSFER(THRESH,1)
...
C....          CALCULATE TREES/ACRE ELIGIBLE FOR WINDTHROW.
               ...
               WRITE(0,*) 'WIN-ALL ISPI=',ISPI,' I=',I,
     &  ' PCTx=',TRANSFER(PCT(I),1),' HTx=',TRANSFER(HT(I),1)
               WRITE(0,*) 'WIN-AL2 I=',I,
     &  ' DBHx=',TRANSFER(DBH(I),1),' PROBx=',TRANSFER(PROB(I),1)
               WRITE(0,*) 'WIN-AL3 I=',I,
     &  ' WK2bx=',TRANSFER(WK2(I),1),' ROWx=',TRANSFER(ROWDOM(ISPI),1)
...
C.... WINDTHROW.
  ...
  400 CONTINUE
     ...
     &   ' TOTAL ELIGIBLE = ',TELIG
      WRITE(0,*) 'WIN-AGG TELIGx=',TRANSFER(TELIG,1),
     &  ' TOTSUCx=',TRANSFER(TOTSUC,1),
     &  ' SPCNUMx=',TRANSFER(SPCNUM,1)
...
C....             THE CURRENT RECORD WILL SHOW WINDTHROW MORTALITY.
     ...
     &               WK2(I) = PROB(I) - 1E-6
                  WRITE(0,*) 'WIN-REC I=',I,' ISPI=',ISPI,
     &  ' PRPx=',TRANSFER(PRPMRT(ISPI),1),
     &  ' WK2x=',TRANSFER(WK2(I),1)
...
C....       THEN SET OKILL TO EQUAL THE NUMBER OF LARGE DF WINDTHROWN.
         ...
         ENDIF
         WRITE(0,*) 'WIN-END DF9KILx=',TRANSFER(DF9KIL,1),
     &  ' OKILLx=',TRANSFER(OKILL,1),' LDFBGO=',LDFBGO
