...
C
         INVYR = IY(1)
         WRITE(0,*) 'SCH-INIT INVYR=',IY(1),' IPAST=',IPAST,
     &      ' IWAIT=',IWAIT,' IFINYR=',IY(NCYC)+10,' NCYC=',NCYC,
     &      ' DBEVNThex=',0
         I1 = 1
         IPREV = IPAST
         IFINYR = IY(NCYC) + 10
...
C
  200    CONTINUE
         CALL DFBRAN(RAND)
         WRITE(0,'(A,I4,A,Z8.8,A,Z8.8)') 'SCH-DRAW NYR=',NYR,
     &      ' RAND=',TRANSFER(RAND,1),' DBEVNT=',TRANSFER(DBEVNT,1)
...
C
         WRITE(0,*) 'SCH-OPNEW NEXT=',NEXT,' IYI=',IYI,
     &      ' IYyr=',IY(IYI)
