...
C.... A DBH >= 9".
  ...
  150    CONTINUE
      ...
      WRITE(0,'(A,Z8.8,A,Z8.8,A,Z8.8,A,L2)') 'MRTHEAD DFKILL=',
     &   TRANSFER(DFKILL,1),' BADF9=',TRANSFER(BADF9,1),
     &   ' SUMDBH=',TRANSFER(SUMDBH,1),' LBAMOD=',LBAMOD
...
C....    TREE RECORD IS NOT GREATER THAN THE NUMBER THAT EXIST.
         ...
         WRITE(0,'(A,I4,A,Z8.8,A,Z8.8,A,I2,A,Z8.8,A,Z8.8)')
     &     'MRT J=',J,' D=',TRANSFER(D,1),' P=',TRANSFER(P,1),
     &     ' DCLAS=',DCLAS,' TAMORT=',TRANSFER(TAMORT,1),
     &     ' WK2=',TRANSFER(WK2(J),1)
