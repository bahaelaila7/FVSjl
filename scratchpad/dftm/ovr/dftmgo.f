...
C     
      ...
      DO 80 II = I1, I2
        I = IND1(II)
        CNTDF = CNTDF + PROB(I)
        WRITE(0,'(A,Z8.8)') 'DBGGODF ',TRANSFER(PROB(I),II)
   80 CONTINUE
...
C     
      ...
      DO 130 II = I1, I2
        I = IND1(II)
        CNTGF = CNTGF + PROB(I)
        WRITE(0,'(A,Z8.8)') 'DBGGOGF ',TRANSFER(PROB(I),II)
  130 CONTINUE
...
C     
      ...
      WRITE(0,7801) TRANSFER(CNTDF,I),TRANSFER(CNTGF,I),IDF,IGF,
     >   NACLAS(1),NACLAS(2),NCLAS(1),NCLAS(2),LDF,LGF,L
 7801 FORMAT('DBGGO ',2(1X,Z8.8),6(1X,I4),3(1X,L1))
