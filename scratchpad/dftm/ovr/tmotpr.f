...
C     
  ...
  110 CONTINUE
      WRITE(0,7701) TRANSFER(ELEV,I),TRANSFER(SLOPE,I),
     >   TRANSFER(ASPECT,I),TRANSFER(TOPO,I),TRANSFER(TMASHD,I),
     >   TRANSFER(BA,I),TRANSFER(RELDEN,I),TRANSFER(RELDSP(3),I),
     >   TRANSFER(RELDSP(4),I),TRANSFER(TPROB,I)
 7701 FORMAT('DBGOTPRIN ',10(1X,Z8.8))
      WRITE(0,7702) IPRBMT,TRANSFER(PGFBA,I),TRANSFER(PROTBK,I)
 7702 FORMAT('DBGOTPROUT ',I2,2(1X,Z8.8))
      RETURN
      END
