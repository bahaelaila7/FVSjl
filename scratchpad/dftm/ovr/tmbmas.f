...
C
    ...
    8   CONTINUE  
     ...
     &             0.0048268 * (TPROB**2 / 10000)     
      ...
      WRITE(0,7901) IS,ISP(IK),TRANSFER(SLOPE,J),TRANSFER(ASPECT,J),
     &   TRANSFER(BA,J),TRANSFER(TPROB,J),TRANSFER(RELDEN,J),
     &   TRANSFER(DBH(IK),J),TRANSFER(HT(IK),J),TRANSFER(DGI,J),
     &   TRANSFER(CR,J),TRANSFER(PCT(IK),J),TRANSFER(FBIOMS(IS),J),
     &   TRANSFER(PCNEWF(IS),J)
 7901 FORMAT('DBGBMAS2 ',I3,1X,I2,12(1X,Z8.8))
