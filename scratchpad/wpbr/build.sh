#!/bin/bash
# FVSie_wpbr relink (my scratchpad copy). Optional arg1 = dir of instrumented *.f overrides.
set -u
SRC=/workspace/ForestVegetationSimulator/bin/FVSie_buildDir
WPBR=/workspace/ForestVegetationSimulator/wpbr
WORK=/tmp/claude-1000/-workspace/b4e1b3b1-495b-403e-810b-5db3604b56cc/scratchpad/wpbr
OBJ=$WORK/ieobj
