...
C
      ...
      OPEN(78,FILE='bwedam_dump.txt',STATUS='UNKNOWN',
     &     POSITION='APPEND')
...
C
     ...
     >     RHTGM1(IHOST,ISZI))*RHTGM1(IHOST,ISZI)**.5509
      ...
      RHTGM1(IHOST,ISZI)=RHTG
            WRITE(78,7801) ICYC,IYRCUR,IHOST,ISZI,
     &        TRANSFER(AVPRBO(IHOST,ISZI,1),IHX78),
     &        TRANSFER(AVPRBO(IHOST,ISZI,2),IHX78),
     &        TRANSFER(BWERDI,IHX78),TRANSFER(BWERHI,IHX78),
     &        TRANSFER(RDDS,IHX78),TRANSFER(RHTG,IHX78)
 7801       FORMAT('DAM',4(1X,I5),6(1X,Z8.8))
