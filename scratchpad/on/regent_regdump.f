...
C
 ...
 9987   FORMAT(' IN REGENT, I=',I4,',  ISPC=',I3,'  CUR HT=',F7.2,
     ...
     &       ',  DBH INC(I,K)=',2F7.4)
      ENDIF
      IF(D.LT.XMX) THEN
        JHX1=TRANSFER(HT(I),0)
        JDX1=TRANSFER(D,0)
        JGX1=TRANSFER(HTG(K),0)
        JZG1=TRANSFER(DG(K),0)
        WRITE(773,7731) I,ISPC,K,JHX1,JDX1,JGX1,JZG1
 7731   FORMAT(3I6,4(1X,Z8.8))
      ENDIF
   23 CONTINUE
C----------
