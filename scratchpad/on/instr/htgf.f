...
C
      ...
      INTEGER*4 IZA,IZB,IZC,IZD,IZE,IZF,IZG,IZH,IZI,IZJ
      REAL SIMD
...
C
     ...
     &  HTNOW, '  HTG(I)=',HTG(I),' XHT=',XHT,' XHT2=',XHT2
      ...
      TEMHTG=HTG(I)
      SIMD=SITEAR(ISISP)*FTtoM
      IZA=TRANSFER(DBH(I),IZA)
      IZB=TRANSFER(DBH10,IZB)
      IZC=TRANSFER(RMSQD,IZC)
      IZD=TRANSFER(BA,IZD)
      IZE=TRANSFER(QMD10,IZE)
      IZF=TRANSFER(BA10,IZF)
      IZG=TRANSFER(SIMD,IZG)
      IZH=TRANSFER(HTNOW,IZH)
      IZI=TRANSFER(HT10,IZI)
      IZJ=TRANSFER(TEMHTG,IZJ)
      WRITE(773,7731) I,ISPC,IZA,IZB,IZC,IZD,IZE,IZF,IZG,IZH,IZI,IZJ
 7731 FORMAT(2I6,10(1X,Z8.8))
C----------
