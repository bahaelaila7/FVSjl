...
C     CHECK FOR DEBUG
      ...
      CV = VM * X
      IZM1=TRANSFER(VM,IZM1)
      IZM2=TRANSFER(ABIRTH(IT),IZM2)
      IZM3=TRANSFER(CV,IZM3)
      WRITE(775,7751) ISPC,IZM1,IZM2,IZM3
 7751 FORMAT(I6,3(1X,Z8.8))
      RETURN
