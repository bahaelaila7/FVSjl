...
C----------
      ...
      INTEGER*4 IZV1,IZV2,IZV3,IZV4,IZV5
      REAL VOLCOR,PULPV
...
C----------
      WK1(I)=VM
      IZV1=TRANSFER(D,IZV1)
      IZV2=TRANSFER(H,IZV2)
      IZV3=TRANSFER(VN,IZV3)
      IZV4=TRANSFER(VM,IZV4)
      IZV5=TRANSFER(BARK,IZV5)
      WRITE(774,7741) I,ISPC,IZV1,IZV2,IZV3,IZV4,IZV5
 7741 FORMAT(2I6,5(1X,Z8.8))
C----------
