...
Correctness floor (never regress): **38511 pass / 143 broken / 0 fail** (`julia --project=. test/runtests.jl`).
(+32 pass / +2 broken since 38479/141 — S96 NE snag height-loss + S97 NE carbon-report validation.)
