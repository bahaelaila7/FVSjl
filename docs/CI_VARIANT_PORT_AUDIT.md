...
| 6 | Small-tree: ci/regent.f | ◐ **coeffs extracted** (data/centralidaho/regent_coeffs_1d.csv, 14×19: small-tree DG CNST/CR/CRSQ/DGMAX + height DHCN/DHCR/DHHT/HDM1/HDM2/RLHT + context BAL/PBAL/STBA/HTBA; bounds XMAX=5/XMIN=2). Port small_tree_growth!(::CentralIdaho) next (clone ie/regent.jl NPER-subcycle NIVAR path). |
