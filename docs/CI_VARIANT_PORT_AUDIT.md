...
| 4 | Height: ci/htgf.f (western site-curve POTHTG) | ◐ scoped: coeffs HGLD(19, extracted) + RHK/BIAS scalars + site-index curves (SITAGE/SITHT/AGMAX/HTMAX/SINDX) → POTHTG=HGUESS−SITHT; species branches CASE(11:13,16,17,19)/CASE(14)WJ/CASE(15)MC. Clone ie/kt height_growth.jl. Port next → unblocks full-cycle .sum → validates DG+height together. |
