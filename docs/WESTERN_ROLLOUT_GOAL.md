...
**The remaining surface (all niche; the CORE simulator — every variant + every major extension — is DONE):**
  ...
  4. **Deferred sub-paths** — **WSBWE BUDLITE/GENDEFOL ✓ DONE 2026-08-22 (0ffd6466 port + f565f1e1 test)** — the
     missing weather file was SYNTHESIZED (synwx.txt BWEATH 10×4, fed IDENTICALLY to both engines = real bit-exact
     A/B per USER "make synthetic, clearly separate synthetic from faithful"); bwein/bwewea(594/594)/bwelit+bwedie+
